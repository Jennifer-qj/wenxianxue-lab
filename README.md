...
本项目不是《文献学概要》的在线电子版，也不把结构化完成冒充为学术核验完成。十四章已经进入内容系统；当前 9/143 个学习单元完成纸本核验，另有 113 个单元完成带页码文字稿预对读，其余内容公开保留待复核状态。预对读只用于纠正概括和登记疑点，不代替实体纸本终审。
