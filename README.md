...
> 我没有等到“全部读懂”以后才开始。遇到一个难以把握的概念，我会先画出它和别章的关系，再试着把它改成一次排序、比较或证据判断。

本项目不是《文献学概要》的在线电子版，也不把结构化完成冒充为学术核验完成。十四章已经进入内容系统；当前 9/143 个学习单元完成纸本核验，其余 134 个单元均已完成带页码文字稿预对读并保留待纸本终审状态。预对读只用于纠正概括和登记疑点，不代替实体纸本终审。

## 三分钟体验

如果第一次来，不必先读完功能清单：

1. 打开[十分钟项目导览](https://jennifer-qj.github.io/wenxianxue-lab/tour/)，用前 3 分钟经历一次“猜测—证据—修订”。
2. 进入[第五章·文献的版本](https://jennifer-qj.github.io/wenxianxue-lab/chapters/ch05/)，查看一章怎样被拆成知识、证据与任务。
3. 打开[知识图谱](https://jennifer-qj.github.io/wenxianxue-lab/graph/)，选择“一条版本判断怎样成立”，沿问题而不是沿目录浏览。
4. 想直接看最终学习产物，可以打开[只读示例成果册](https://jennifer-qj.github.io/wenxianxue-lab/progress/?welcome=0&portfolio=sample#portfolio)。
...
| 模块 | 读者可以做什么 | 当前规模 |
| --- | --- | ---: |
| 全书学习系统 | 沿 7 条路径或 14 章学习，在章内完成导读、研读、练习与复盘 | 143 个学习单元、134 道练习 |
...
| 公开校对 | 在全书指挥台按优先级、章节和本机进度筛选134项任务，再进入具体单元核对、记录和导出 | 14 章复核工作台、1 个跨章总队列 |

每个公开学习单元都有稳定标识、来源身份和复核状态。当前功能完整度不等于学术核验完成度；[内容审计页](https://jennifer-qj.github.io/wenxianxue-lab/audit/)会公开二者的差别。

## 质量与隐私

- 发布前自动检查内容结构、学术状态、站内链接、233 个页面、关键学习旅程、构建体积与 66 项测试。
...
- 十分钟项目导览：https://jennifer-qj.github.io/wenxianxue-lab/tour/
...
- 第二章纸本复核工作台：https://jennifer-qj.github.io/wenxianxue-lab/review/ch02/
- 第三章纸本复核工作台：https://jennifer-qj.github.io/wenxianxue-lab/review/ch03/
- 第四章纸本复核工作台：https://jennifer-qj.github.io/wenxianxue-lab/review/ch04/
- 第五章纸本复核工作台：https://jennifer-qj.github.io/wenxianxue-lab/review/ch05/
- 第六章纸本复核工作台：https://jennifer-qj.github.io/wenxianxue-lab/review/ch06/
- 第七章纸本复核工作台：https://jennifer-qj.github.io/wenxianxue-lab/review/ch07/
...
- 本地学习数据与安全问题的处理方式见 [SECURITY.md](./SECURITY.md)。
- Pull Request 会自动执行内容门禁、233 页公开页面审计、构建、断链检查和测试；依赖更新由 Dependabot 按月检查。
